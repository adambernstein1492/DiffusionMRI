...
#ifdef MRI_DIFF_SIM
  new_volume_mol->orig_pos = old_volume_mol->orig_pos;
  new_volume_mol->offset = old_volume_mol->offset;
  new_volume_mol->phase_shift = old_volume_mol->phase_shift;
  new_volume_mol->Mx = old_volume_mol->Mx;
  new_volume_mol->My = old_volume_mol->My;
  new_volume_mol->Mz = old_volume_mol->Mz;
#endif /* MRI_DIFF_SIM */
...
#ifdef MRI_DIFF_SIM
						    struct volume_molecule *destroyed_mol,
#endif /* MRI_DIFF_SIM */
                                                    struct wall *w,
...
#ifdef MRI_DIFF_SIM
  new_volume_mol->orig_pos = destroyed_mol->orig_pos;
  new_volume_mol->offset = destroyed_mol->offset;
  new_volume_mol->phase_shift = destroyed_mol->phase_shift;
  new_volume_mol->Mx = destroyed_mol->Mx;
  new_volume_mol->My = destroyed_mol->My;
  new_volume_mol->Mz = destroyed_mol->Mz;
#endif /* MRI_DIFF_SIM */
