...
%type <dbl> relaxation_T1_def
%type <dbl> relaxation_T2_def
%type <dbl> lambda_1_def
%type <dbl> lambda_2_def
%type <dbl> lambda_3_def
...
molecule_stmt:
          new_molecule '{'
              ...
              lambda_2_def
              lambda_3_def
          '}'                                         { CHECKN($$ = mdl_assemble_mol_species(mdlpvp, $1, $3, $4.D, $4.is_2d, $5, $6, $7, $8, $9, $10, $11, $12 )); }
;
...
viz_output_maybe_mode_cmd: /* empty */                { CHECK(mdl_set_viz_mode(mdlpvp, mdlpvp->vol->viz_blocks, CELLBLENDER_MODE)); }
                         | viz_mode_def               { CHECK(mdl_set_viz_mode(mdlpvp, mdlpvp->vol->viz_blocks, $1)); }
;
